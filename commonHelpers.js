...
`).join(""),d=document.querySelector(".js-gallery");document.querySelector(".js-search-form");document.querySelector(".js-loader");m().then(r=>{d.innerHTML=u(r.results)}).catch(r=>console.log(r));
